      ...
      try {
        ...
        if (res.ok) {
          ...
          if (data.has_submitted_survey) {
            ...
            setShowSurvey(false); // don’t show until clicked
            setShowBlur(true); // show blur
          }
        } else {
  ...
  return (
    ...
    <Navbar/>
        ...
        {!hasSubmitted && showBlur && (
          ...
          {!hasSubmitted && !showSurvey && showBlur && (
            <div className="fixed inset-0 flex items-center justify-center z-50">
              <button
                ...
                className="px-8 py-4 rounded-xl text-white/70 font-semibold shadow-lg
    ...
    <div className="flex">
      ...
      <div className="flex-1 p-10 z-10">
        <div className="mt-12">
          ...
          <h1 className="ml-2 text-lg">Here are some yearbooks for you to explore:</h1>
        </div>
        <div className="flex flex-wrap gap-4 justify-start mt-5 mb-24 z-50">
          ...
          {/* Survey modal only if NOT submitted */}
        {!hasSubmitted && showSurvey && (
          <div className="fixed inset-0 flex justify-center items-center z-50">
            <Surveyq onSurveySubmit={() => setHasSubmitted(true)} />
          </div>
        )}
    </div>
  );
