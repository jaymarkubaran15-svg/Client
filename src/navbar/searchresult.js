  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 p-6 md:ml-64 bg-gray-50 min-h-screen">
        ...
        <div className="flex items-center bg-white p-4 rounded-lg shadow-lg mb-6 border border-gray-300 hover:border-gray-400 transition-all">
        ...
        {displayData.length > 0 ? (
          displayData.map((item) => (
            <div key={`${item.type}-${item.id}`} className="bg-white p-6 rounded-lg shadow-md mb-4 hover:shadow-lg transition-all">
